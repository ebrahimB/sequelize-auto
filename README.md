...
* Sequelize v5 support
* Pascal Capitalization - alternate to camel case
* Output ts model definitions - useful for front end use

## Local Development

Fork the project and use the following command to install the package locally:

`npm i -g <PATH>\sequelize-auto`
...
## Usage
    ...
    Options:
      ...
      -Z, --typescript-only     Only output models with typescript definitions.
      -f, --case-for-file-name  Set the case type for the file names ("camel", "pascal", "upper")

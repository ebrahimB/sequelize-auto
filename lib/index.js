  ...
  function generateText(err) {
    ...
    async.each(_.keys(self.tables), function(table, _callback){
      ...
      _.each(fields, function(field, i){
        ...
        // TODO: This is a workaround to get the auto increment and is unique attributes in sequelize auto. Ideally this needs to 
        // be updated to the latest sequelize and tested with
        if(fieldName === "id"){
